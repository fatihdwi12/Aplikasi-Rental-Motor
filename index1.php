...
<header class="header">
    ...
    <a href="#" class="logo"> <span>RENT</span>BIKE </a>
...
<h1 class="heading"> Ready Best <span>Motorcycle</span> vehicles</h1>
...
<section class="footer" id="footer">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <a href="https://www.instagram.com/fatihdwilaksana/"> <i class=""></i> Instagram </a>
            <a href=""> <i class=""></i> WhatsApp </a>
        </div>

    </div>

    <div class="credit">Kelompok 3 Rekyasa Perangkat Lunak</div>
